...
echo "*******************************************"
echo "Doublet Combination" ${doublet[first_combination]} ${doublet[second_combination]} ${doublet[third_combination]} ${doublet[fourth_combination]}
doublet[first_per]=$(echo $total_first_comb $FLIP | awk '{print $1/$2}')
echo "Percentage of HH Combination ="${doublet[first_per]}

doublet[second_per]=$(echo $total_second_comb $FLIP | awk '{print $1/$2}')
echo "Percentage of HT Combination ="${doublet[second_per]}

doublet[third_per]=$(echo $total_third_comb $FLIP | awk '{print $1/$2}')
echo "Percentage of TH Combination ="${doublet[third_per]}

doublet[fourth_per]=$(echo $total_fourth_comb $FLIP | awk '{print $1/$2}')
